  ...
  <head>
    ...
    <div id="main">
      <div style="width: 90% !important; margin-left: 5%;">
        <div class="col-lg-12">
              <meta charset="UTF-8">
    <title>RustyPot.com | Give away</title>
<style>
body {
  ...
  background-size: cover;
    ...
    <link rel="stylesheet" href="/templates/css/giveaway.css">
<div align="center">
<br><br>
<br><br>
<br><br>
<a class="e-widget no-button" href="https://gleam.io/iQv6O/maxmears-rust-skin-giveaway" rel="nofollow">MaxMears Rust Skin Giveaway</a>
<script type="text/javascript" src="/templates/js/gleam.io.js" async="true"></script>
</div>
        </div>
      </div>  
    </div>     
      ...
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
          <div class="modal-header text-center">
            ...
            <h4 style="color:#000;"class="modal-title">Support</h4>
          </div>
          <div class="modal-body">
            <p style="color:#000;">Join our Official Discord <a style="color:#000;"href="https://discord.gg/TPnu9rp" target="_blank"><h4>HERE</h4></a></p>
			      <p style="color:#000;">Or send us an email to: contact@rustypot.com</p>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h1>Get Started:</h1>
              ...
              <li style="color:#000;">You should login with your Steam account.</li>
              <li>
              Set your trade link by editing your Steam Profile URL.
              <p style="color:#000;">This is a necessary step to receive the items you win and also to deposit skins.</p>
              </li>
              <li style="color:#000;">
              After it you can start to deposit.
              <p style="color:#000;">(So you can not accidentally deposit your skins, you have to confirm it on your phone!)</p>
              </li>
              <li style="color:#000;">Once the item threshold of 200 items is reached, the winner will be announced.<br>
